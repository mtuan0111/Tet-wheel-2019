...
var Stats = function() {
    ...
    _fpsDiv.style.backgroundColor =
        "rgb(" +
        Math.floor(_fpsColors[0][0] / 2) +
        "," +
        Math.floor(_fpsColors[0][1] / 2) +
        "," +
        Math.floor(_fpsColors[0][2] / 2) +
        ")";
    ...
    _fpsGraph.style.backgroundColor =
        "rgb(" +
        _fpsColors[1][0] +
        "," +
        _fpsColors[1][1] +
    ...
    _msDiv.style.backgroundColor =
        "rgb(" +
        Math.floor(_msColors[0][0] / 2) +
        "," +
        Math.floor(_msColors[0][1] / 2) +
        "," +
        Math.floor(_msColors[0][2] / 2) +
        ")";
    ...
    _msGraph.style.backgroundColor =
        "rgb(" +
        _msColors[1][0] +
        "," +
        _msColors[1][1] +
    ...
    return {
        ...
        update: function() {
            ...
            if (_time > _timeLastSecond + 1000) {
                ...
                _fpsText.textContent =
                    _fps + " FPS (" + _fpsMin + "-" + _fpsMax + ")";
